...
import 'package:py_quest/Screens/ExerciseScreens/question2Screen.dart';
import 'package:py_quest/Utils/device_info.dart';

class ExerciseScreen extends StatefulWidget {
  String id;
  ExerciseScreen({super.key, required this.id});
        ...
        child: Column(
          children: [
            ...
            AnotherStepper(
              ...
              iconWidth: 40,
              iconHeight: 40,
              activeBarColor: isCorrect == true ? Colors.green : Colors.red,
